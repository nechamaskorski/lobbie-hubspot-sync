...
def update_clickup_insurance_fields(task_id, insurance_fields):
    ...
    field_map = {
        "insurance_company": "7b129add-1987-4230-803e-644f7b42f8b5",
        "insurance_id": "c4acc13d-8618-49b4-8b35-d3420c8a2025",
        "policyholder": "30e7adcf-ed06-4418-89fd-eb42e37c72f7",
        "secondary_insurance_company": "2aeed84d-3076-4182-b3a0-60c480208f96",
        "secondary_insurance_id": "397ddcdc-ee5d-448b-b6b6-fb7df2c4478a",
        "secondary_policyholder": "0f6fb32d-0239-472d-91d3-0b7861033558",
    }
    ...
    # Set secondary insurance checkbox
    if insurance_fields.get("has_secondary"):
        try:
            requests.post(
                f"{BASE_URL}/task/{task_id}/field/fe74b42c-c243-410a-aa5d-2d8a9a71ce0e",
                headers=HEADERS,
                json={"value": True},
            )
        except Exception as e:
            print(f"Failed to set secondary insurance checkbox: {e}")